# Sponge Code Agent (原 SelfEvolve Code Agent)

## 产品需求文档 v1.0

| 文档信息 | 内容 |
|---------|------|
| 产品名称 | Sponge Code Agent |
| 产品版本 | v1.0 |
| 文档日期 | 2026-04-15 |
...
**Sponge Code Agent** 是一款基于大语言模型和 LangGraph 工作流引擎构建的智能编程助手，能够接收自然语言描述的开发任务，自主完成需求分析、代码生成、执行验证、结果评估和自我修正的全流程工作，最终交付满足要求的可运行代码。
...
| 特性 | 传统 IDE 插件 | 通用 ChatGPT | Sponge Code Agent |
|------|--------------|-------------|----------------------|
